...
public class MainActivity extends AppCompatActivity {
    ...
    private void createAndStoreRecipes() {
        ...
        // Create some recipes
        List<String> ingredients3 = Arrays.asList("");
        Recipe recipe3 = new Recipe("3", "Stewed Beef Brisket with Potatoes", "Dinner", ingredients3, "savory", false, 0, 0, "",0, 4);
        ...
        Recipe recipe4 = new Recipe("4", "Bacon and Egg Muffins", "Breakfast", ingredients4, "savory", false, 400, 30, "Preheat oven to 350°F. Grease a 12-cup muffin tin.#Cook bacon in a skillet over medium heat until crispy. Set aside to cool, then crumble into small pieces.#In a large bowl, whisk together eggs, milk, salt, and pepper. Stir in crumbled bacon, cheddar cheese, and chopped green onions.#Spoon the egg mixture into the prepared muffin tin, filling each cup about ⅔ full.#Bake for 20-25 minutes or until the egg muffins are set and cooked through. Allow to cool for a few minutes before removing from the tin.",R.drawable.bacon_egg_muffins, 5);
